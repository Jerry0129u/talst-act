...
import { signInWithCredential } from "https://www.gstatic.com/firebasejs/10.12.0/firebase-auth.js";
...
window.signInGoogle = async () => {
    try {
        if (isNative) {
            // --- NATIVE iOS/Android ---
            const { FirebaseAuthentication } = await import('https://cdn.jsdelivr.net/npm/@capacitor-firebase/authentication@6.1.0/dist/esm/index.js');
        ...
        toast('Нэвтрэхэд алдаа гарлаа: ' + (err.message || err), 'err');
    }
};
